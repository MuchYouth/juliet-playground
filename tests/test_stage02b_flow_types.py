...
def test_flow_type_from_function_groups_numbered_sources_and_sinks():
    ...
    cases = [
        ...
        ('b2g', 'goodB2G1VaSinkG', 'b2g1'),
        ('b2g', 'goodB2G2VaSinkG', 'b2g2'),
        ('b2g', 'goodB2G1_vasink', 'b2g1'),
        ('b2g', 'goodB2G2_vasink', 'b2g2'),
        ('b2g', 'goodB2G1Static', 'b2g1'),
        (
            'b2g',
        ...
        (
            'b2g',
            'CWE134_Uncontrolled_Format_String__char_console_vfprintf_22_goodB2G1_vasink',
            'b2g1',
        ),
        (
            'b2g',
        ...
        ('g2b', 'goodG2B1VaSinkB', 'g2b1'),
        ('g2b', 'goodG2B2Global', 'g2b2'),
        ('g2b', 'goodG2B2VaSinkB', 'g2b2'),
        (
            'g2b',
